...
//include '../config.inc.php'; //MUITHI | 11-SEPT-2015
include 'config.inc.php'; //MUITHI | 11-SEPT-2015

//START | MUITHI | 24-JAN-2014 | PREVENT EXPLORER 10 & ABOVE NUISANCE
echo '<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE8">
	  <meta http-equiv="X-UA-Compatible" content="IE=8">';
//END | MUITHI 

if ($request !== 'POST') {include 'header_get.php';include 'topmain.php';} //MUITHI | YOU MAY NEED TO REMOVE THESE SCRIPTS | 11-SEPT-2015
...
//START | MUITHI | LEAVE SYSTEM CONFIGURATIONS TO SYSTEM DEVELOPERS | 29-JAN-2014 1-45PM
/*				
...
//echo "            <form name='form' id='jmu_regnform' action='$self' method='post'>\n";
echo "            <form name='form' id='jmu_regnform' action='' method='post'>\n";
...
//START | MUITHI | 15-JAN-2014
echo "				<tr><td colspan='2' style='border:1px solid #999999;' bgcolor='#F0F0F0'  align='center'>Fingerprint Registration Here?<br/><br/></td></tr>
					<tr><td class=table_rows height=25 width=100% colspan='2' style='padding-left:32px; border:1px solid #999999;' bgcolor='#F0F0F0'  align='center' nowrap>
                    <input type='hidden' name='f_no1' id='f_no1'>
                    <input type='hidden' name='f_no2' id='f_no2'>
                    <input type='hidden' name='fptemplate1' id='fptemplate1'>
                    <input type='hidden' name='fptemplate2' id='fptemplate2'>";
echo $load_enroll."<br/>";
echo "</td>\n</tr>";
//END | MUITHI | 15-JAN-2014
//echo '<script type="text/vbscript">';
//include 'jmu_registration.vbs';
//echo '<script><br/>';
...
$f_no1 = $_POST['f_no1'];
$f_no2 = $_POST['f_no2'];
$fptemplate1 = $_POST['fptemplate1'];
$fptemplate2 = $_POST['fptemplate2'];
//END | MUITHI | 15-JAN-2014
...
(empty($display_name)) || (empty($email_addy)) || (empty($office_name)) || (empty($group_name)) ||(empty($fptemplate1)) ||(empty($fptemplate2)) ||(empty($f_no1)) ||(empty($f_no2)) ||
//(!eregi ("^([[:alnum:]]|~|\!|@|#|\$|%|\^|&|\*|\(|\)|-|\+|`|_|\=|\{|\}|\[|\]|\||\:|\<|\>|\.|,|\?)+$", $password)) ||
(!preg_match ("/^([[:alnum:]]|~|\!|@|#|\$|%|\^|&|\*|\(|\)|-|\+|`|_|\=|[{]|[}]|\[|\]|\||\:|\<|\>|\.|,|\?)+$/", $password)) ||
(!preg_match ("/^([[:alnum:]]|_|\.|-)+@([[:alnum:]]|\.|-)+(\.)([a-z]{2,4})$/", $email_addy)) || (($admin_perms != '1') && (!empty($admin_perms))) || 
...
elseif (empty($fptemplate1)) {
echo "            <table align=center class=table_border width=60% border=0 cellpadding=0 cellspacing=3>\n";
echo "              <tr>\n";
echo "                <td class=table_rows width=20 align=center><img src='../images/icons/cancel.png' /></td><td class=table_rows_red>
                    Fingerprint 1 is required.</td></tr>\n";
echo "            </table>\n";
}
elseif (empty($fptemplate2)) {
echo "            <table align=center class=table_border width=60% border=0 cellpadding=0 cellspacing=3>\n";
echo "              <tr>\n";
echo "                <td class=table_rows width=20 align=center><img src='../images/icons/cancel.png' /></td><td class=table_rows_red>
                    Fingerprint 2 is required.</td></tr>\n";
echo "            </table>\n";
}
...
//elseif (!eregi ("^([[:alnum:]]|~|\!|@|#|\$|%|\^|&|\*|\(|\)|-|\+|`|_|\=|[{]|[}]|\[|\]|\||\:|\<|\>|\.|,|\?)+$", $password)) {
elseif (!preg_match ("/^([[:alnum:]]|~|\!|@|#|\$|%|\^|&|\*|\(|\)|-|\+|`|_|\=|[{]|[}]|\[|\]|\||\:|\<|\>|\.|,|\?)+$/", $password)) {
echo "            <table align=center class=table_border width=60% border=0 cellpadding=0 cellspacing=3>\n";
echo "              <tr>\n";
echo "                <td class=table_rows width=20 align=center><img src='../images/icons/cancel.png' /></td><td class=table_rows_red>
...
elseif (!preg_match ("/^([[:alnum:]]|_|\.|-)+@([[:alnum:]]|\.|-)+(\.)([a-z]{2,4})$/", $email_addy)) {
echo "            <table align=center class=table_border width=60% border=0 cellpadding=0 cellspacing=3>\n";
echo "              <tr>\n";
echo "                <td class=table_rows width=20 align=center><img src='../images/icons/cancel.png' /></td><td class=table_rows_red>
...
//START | MUITHI | 15-JAN-2014
echo "              <tr><td class=table_rows height=25 width=100% colspan='2' style='padding-left:32px;' nowrap>Fingerprint Registration Here?<br/><br/>
                    <input type='hidden' name='f_no1' id='f_no1'>
                    <input type='hidden' name='f_no2' id='f_no2'>
                    <input type='hidden' name='fptemplate1' id='fptemplate1'>
                    <input type='hidden' name='fptemplate2' id='fptemplate2'>";
...
//START | MUITHI | 16-JAN-2014 ADD BIO DATA TO DATABASE
$query3 = "insert into ".$db_prefix."employees (empfullname, displayname, employee_passwd, email, groups, office, admin, reports, time_admin, disabled, f_no1, f_no2, fptemplate1, fptemplate2) 
           values ('".$post_username."', '".$display_name."', '".$password."', '".$email_addy."', '".$group_name."', '".$office_name."', '".$admin_perms."', 
           '".$reports_perms."', '".$time_admin_perms."', '".$post_disabled."','".$f_no1."', '".$f_no2."', '".$fptemplate1."', '".$fptemplate2."')";
//END | MUITHI
